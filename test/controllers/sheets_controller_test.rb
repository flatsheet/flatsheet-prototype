...
class SheetsControllerTest < ActionController::TestCase
  ...
  test "should create sheet" do
    assert_difference('Sheet.count') do
      post :create, sheet: { description: @sheet.description, fields: @sheet.fields, name: @sheet.name }
    end
  ...
  test "should update sheet" do
    patch :update, id: @sheet, sheet: { description: @sheet.description, fields: @sheet.fields, name: @sheet.name }
    assert_redirected_to sheet_path(assigns(:sheet))
  end
